...
class DateResolverTest extends TestCase
{
    ...
    public function testSchoolStartedin2019InFirstYearWhoBeginAt11Has2008AsGreatestYearBirthForStudent()
    {
    ...
    public function testSchoolStartedin2018InFirstYearWhoBeginAt11Has2007AsGreatestYearBirthForStudent()
    {
    ...
    public function testSchoolStartedin2018InFirstYearWhoBeginAt12Has2006AsGreatestYearBirthForStudent()
    {
    ...
    public function testSchoolStartedin2018InSecondYearWhoBeginAt12Has2007AsGreatestYearBirthForStudent()
    {
        $schoolConfiguration = new MagicSchoolConfiguration(2018, 12, 0, 0, 0);
    ...
    public function testScholStartedIn2019InFirstYearWhoBeginAt11AndHave7YearToStudyHas2001AsLowestYearBirthForStudent()
    {
    ...
    public function testScholStartedIn2018InFirstYearWhoBeginAt11AndHave7YearToStudyHas2000AsLowestYearBirthForStudent()
    {
    ...
    public function testScholStartedIn2018InFirstYearWhoBeginAt11AndHave10YearToStudyHas1997AsLowestYearBirthForStudent()
    {
